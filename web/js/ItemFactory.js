var ItemFactory = {
	items: {
		...
		bow: {name: "Bow", tex: "items", subImg: 9, type: 'weapon', str: '10D4', ranged: true, subItemName: 'arrow', wear: 0.01},
		crossbow: {name: "Crossbow", tex: "items", subImg: 10, type: 'weapon', str: '13D4', ranged: true, subItemName: 'crossbow bolt', wear: 0.008},
		mysticSword: {name: "Mystic Sword", tex: "items", subImg: 8, type: 'weapon', str: '16D16', wear: 0.008},
		
		// Armour
		leather: {name: "Leather armour", tex: "items", subImg: 11, type: 'armour', dfs: '18D8', wear: 0.05},
		chain: {name: "Chain mail", tex: "items", subImg: 13, type: 'armour', dfs: '20D8', wear: 0.015},
		plate: {name: "Plate mail", tex: "items", subImg: 14, type: 'armour', dfs: '22D8', wear: 0.008},
		mystic: {name: "Mystic armour", tex: "items", subImg: 15, type: 'armour', dfs: '31D8', wear: 0.005},
