var EnemyFactory = {
	enemies: {
		...
		daemon: {name: 'Daemon', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},				// not in u5
		firelizard: {name: 'Fire Lizard', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},		// not in u5
		hydra: {name: 'Hydra', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},				// not in u5
		seaSerpent: {name: 'Sea Serpent', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},		
		octopus: {name: 'Kraken', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},				// not in u5
		nixie: {name: 'Nixie', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},				// not in u5
		balron: {name: 'Balron', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},				// not in u5
		liche: {name: 'Liche', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},				// not in u5
		...
		zorn: {name: 'Zorn', hp: 25, textureBase: 'bat', stats: {str: '4D2', dfs: '2D2', exp: 5}},					// not in u5
